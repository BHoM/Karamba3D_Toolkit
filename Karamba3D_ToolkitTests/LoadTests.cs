namespace Karamba3D_ToolkitTests
{
    ...
    public class LoadTests : BaseTest
    {
        ...
        [Test]
        public void DistributedLoad_WhenEqualValueAtNodesAreGiven_ConvertToUniformLoadTest_Test()
        {
            // Arrange
            var load = new DistributedForce(
                new[] { string.Empty },
                null,
                "TestLoadCase",
        ...
        public void DistributedLoad_WhenMoreThen2ValuesAreGiven_ConvertToASetOfVaryingLoads_Test()
        {
            ...
            var load = new DistributedForce(
                ...
                new[] { 0.2, 0.5, 0.75 },
                new[] { 1.0, 2.0, 3.0 });
            var model = TestUtilities.CreateHingedBeamModel(additionalEntities: load);
        ...
        public void UniformLoadOld_ConversionTest(LoadOrientation loadOrientation)
        {
            // Arrange
            var vector = new Vector3(1, 2, 3);
            var load = new UniformlyDistLoad_OLD(
                new[] { string.Empty },
                null,
                vector,
                loadOrientation,
